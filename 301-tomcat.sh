...
tomcatDownloadUrl="https://archive.apache.org/dist/tomcat/tomcat-9/v9.0.109/bin/apache-tomcat-9.0.109.tar.gz"
...
cd /opt/tomcat
sudo -u tomcat curl -O $GITDIR/scripts/tomcat/update-app.sh
sudo -u tomcat chmod +x /opt/tomcat/update-app.sh
